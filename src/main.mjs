...
async function start(){
  clearInput();hideModals();shownPlace=0;race=createRace(progress.races);race.truckScale=selected().scale;race.phase='running';world.reset(race.variant);world.setTruck(selected());
