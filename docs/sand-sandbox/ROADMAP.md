...
- The parent confirmed an M2 MacBook Air and an iPad Pro 12.9-inch third generation on iPadOS 26.6.2. Continue via the [Mac handoff](MAC-HANDOFF.md); inspect macOS and tools and confirm the reported device OS before the first signed build.
